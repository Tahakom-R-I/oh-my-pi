...
- Fixed the Ask tool crashing with "undefined is not an object" on headless promptable surfaces (SDK `interactivePrompts`, ACP): option glyphs degrade gracefully when no TUI theme is initialized.
